...
/**
 * student_name values kept out of the PUBLIC leaderboard.
 *
 * A developer account testing the app produces attempts like any other
 * student, but they are not a student and should not appear on a board other
 * students see. This is a display filter only: excluded attempts are still
 * saved and still count toward that account's own dashboard and history.
 */
export const LEADERBOARD_EXCLUDED_NAMES = ['יגאל'];
...
/** The subjects picked in the drawer, so a multi-subject selection survives a reload. */
export const LS_STUDY_SUBJECTS = 'student_trainer_study_subjects';
...
/** The APP_VERSION last shown to this browser by the "מה חדש" screen. */
export const LS_SEEN_VERSION = 'student_trainer_seen_version';
